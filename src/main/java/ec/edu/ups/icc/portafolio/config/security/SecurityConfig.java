    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/projects/portfolio/{portfolioId}").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/availabilities/programmer/{programmerId}/available").permitAll()
                ...
                .requestMatchers(HttpMethod.PUT, "/api/appointments/{id}/approve").hasAnyRole("ADMIN", "PROGRAMMER")
                .requestMatchers(HttpMethod.PUT, "/api/appointments/{id}/reject").hasAnyRole("ADMIN", "PROGRAMMER")
                .requestMatchers(HttpMethod.PUT, "/api/appointments/{id}/complete").hasAnyRole("ADMIN", "PROGRAMMER")
                ...
                .requestMatchers(HttpMethod.PUT, "/api/appointments/{id}/cancel").hasAnyRole("USER", "ADMIN", "PROGRAMMER")
                ...
                .requestMatchers(HttpMethod.GET, "/api/notifications/user/{userId}/count-unread").authenticated()
                .requestMatchers(HttpMethod.PUT, "/api/notifications/{id}/mark-as-read").authenticated()
                .requestMatchers(HttpMethod.PUT, "/api/notifications/user/{userId}/mark-all-as-read").authenticated()
